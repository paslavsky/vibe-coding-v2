...
# INPUT CONTEXT
1.  **Manual Changes:** Analyze the code provided via $ARGUMENTS or by analyzing locally modified files (e.g., using Bash to run `git diff` or checking file history).
