...
# INPUT CONTEXT
1.  **New Requirements:** Analyze the new requests/specs provided via $ARGUMENTS or described in the conversation.
...
1.  **Research (If needed):**
    * If the new requirements contain Web Links or reference new Code Paths, perform the mandatory investigation immediately (same protocol as the plan skill).
