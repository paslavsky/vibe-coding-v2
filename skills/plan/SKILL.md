...
# INPUT CONTEXT
Analyze the requirements provided via $ARGUMENTS or described in the conversation.
...
2.  **Codebase Deep Dive:**
    * For every file/module mentioned or implied: Search the codebase using Glob to find files, Grep to search content, and Read to examine file contents.
